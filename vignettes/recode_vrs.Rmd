...
-   *Are there other functions from other packages that can recode variables/values and attach label attributes?*\
    Yes, such as `Hmisc::upData()`, `expss::apply_labels()` and others....
